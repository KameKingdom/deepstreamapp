        ...
        <>
            <header class="header-3">
                <div class="header-inner">
                    <div class="logo">
                        <b>
                            <Link to="/"><p class="kame_font_001" style={{ fontFamily: "Comic Sans MS" }}>Deep Stream</p></Link>
                        </b>
                    </div>
                    <nav class="header-nav">
                        {user ?
                            <div class="header-nav-item">
                                <Link to="/login" class="header-button header-post">アカウント</Link>
                            </div> :
                            <div class="header-nav-item">
                                <Link to="/login" class="header-button header-post">ログイン</Link>
                            </div>
                        }
                    </nav>
                </div>
            ...
            <div class="empty-header-3"/>
            {
                user ?
                    <>
                        ...
                        <div class="footer">
                            <p class="footer-text">Copyright © 2023 KameKingdom. All Rights Reserved.</p>
                        </div>
                    </> :
                    <>
                        < div class="tab-bar" >

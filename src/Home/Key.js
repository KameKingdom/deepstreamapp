    ...
    useEffect(() => {
        async function fetchFirestoreData() {
            ...
            if (docSnap.exists()) {
                ...
                setImage(docData.image || 'http://deepstream.boo.jp/kame_kingdom/using.png');
        ...
        return (
            <>
                ...
                {name ?
                    ...
                    <>
                        <center>
                            <img src="http://deepstream.boo.jp/kame_kingdom/manager.png" name="ユーザー画像" alt="ユーザー画像" /><br /><br />
                            <table class="kame_table_001">
                                <tr>
                                    <th>愛称</th>
                        ...
                        <br /><br />
                        {
                            !isclicked && !isalreadyuploaded &&
                            <>
                                <button to="/" class="kame_button_light_blue" onClick={UploadKeyHolderClick}><p class="kame_font_002">所持</p></button><br />
                            </>
                        }
                        {
                            isclicked && !isalreadyuploaded &&
